...
describe('HtmlPdf', () => {
    describe('create', () => {
        ...
        it('should spawn Chrome and generate a PDF', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const result = yield HtmlPdf.create('<p>hello!</p>');
            expect(result).to.be.an.instanceOf(HtmlPdf.CreateResult);
        }));
        it('should handle a Chrome launch failure', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        it('should use running Chrome to generate a PDF (specify port)', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        it('should use running Chrome to generate a PDF (specify host and port)', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const launchStub = sinon.stub(chromeLauncher, 'launch');
            try {
        ...
        it('should generate a PDF with Chrome options', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const options = {
                port,
                clearCache: true,
                printOptions: {
        ...
        it('should generate a PDF with cookies', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const options = {
                port,
                cookies: [
                    {
        ...
        it('should proxy console messages', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const events = [];
            const options = {
                port,
      ...
      `;
        ...
        it('should proxy unhandled exceptions', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const now = Date.now();
            let caughtException;
            const options = {
                port,
      ...
      `;
        ...
        it('should timeout', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const options = {
                port,
                timeout: 0,
            };
        ...
        it('should fail to reach an invalid page', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const options = {
                port,
            };
            try {
        ...
        it('should generate a PDF with external JavaScript', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const html = `
        <html>
          <head>
      ...
      `;
        ...
        it('should generate a PDF with external CSS', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
      ...
      `;
        ...
        it('should generate a PDF with multiple pages', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const html = `
        <html>
          <body>
      ...
      `;
        ...
        it('should generate a PDF with custom headers and footers', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const html = `
        <html>
          <head>
            <title>TITLE</title>
      ...
      `;
        ...
        it('should generate a PDF from a local file', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        it('should generate a PDF from an external site', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        `;
                it('should generate prematurely without a CompletionTrigger', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const result = yield HtmlPdf.create(html, { port });
                    expect(result).to.be.an.instanceOf(HtmlPdf.CreateResult);
                    const pdf = yield getParsedPdf(result.toBuffer());
                    expect(pdf.getRawTextContent()).startsWith('Failed!');
                }));
                it('should generate correctly after being triggered', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
        ...
        `;
                ...
                it('should time out', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
                ...
                it('should time out from listening to the wrong event', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
        ...
        `;
                ...
                it('should time out from listening to the wrong callback', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
        ...
        `;
                ...
                it('should time out from listening for the wrong element', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
        ...
        `;
                ...
                it('should time out from listening to the wrong variable', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const options = {
                        port,
        ...
        describe('Concurrent PDF generation', function () {
            ...
            const length = 10;
            it(`should concurrently generate ${length} PDFs`, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    describe('CreateResult', () => {
        ...
        describe('toFile', () => {
            it('should output a file', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    mockFs({
                        myDir: {},
                    });
            ...
            it('should fail output to a nonexistent directory', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    mockFs();
                    const cr = new HtmlPdf.CreateResult(testBase64);
